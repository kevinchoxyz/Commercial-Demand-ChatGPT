...
def _build_trade_inventory_future_hooks_sheet() -> SheetSpec:
    ...
    scenario_default_row = {
        ...
        "shelf_life_ds_months": 24,
        "shelf_life_dp_months": 24,
        "shelf_life_fg_months": 24,
        "shelf_life_ss_months": 24,
        ...
        "active_flag": "yes",
        "notes": "Active deterministic defaults for Phase 3, Phase 4, and Phase 5. Edit here instead of hand-editing phase3_trade_layer.toml, phase4_production_schedule.toml, or phase5_inventory_layer.toml.",
    }
    example_rows = [
        scenario_default_row,
        {
