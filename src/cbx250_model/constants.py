...
PHASE6_BUILD_SCOPE = "deterministic_financial_value_layer"
PHASE6_UPSTREAM_VALUE_CONTRACT = "phase4_monthly_summary.csv + phase5_inventory_outputs.csv"
...
PHYSICAL_SHARED_MODULE = "ALL"
PHYSICAL_SHARED_GEOGRAPHY = "ALL"
