...
def write_phase4_scenario(
    ...
    *,
    ...
    supply_gap_tolerance_units: float = 0.000001,
    capacity_clip_tolerance_units: float = 0.000001,
    ...
    write_lines(
        ...
        [
            ...
            f"supply_gap_tolerance_units = {supply_gap_tolerance_units}",
            f"capacity_clip_tolerance_units = {capacity_clip_tolerance_units}",
            "",
            "[stepdown]",
