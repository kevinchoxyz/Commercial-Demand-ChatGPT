...
def write_phase6_scenario(
    ...
    *,
    ...
    us_fg_sub1_to_sub2_cost_per_unit: float = 25.0,
    eu_fg_sub1_to_sub2_cost_per_unit: float = 57.5,
    us_ss_sub1_to_sub2_cost_per_unit: float = 25.0,
    eu_ss_sub1_to_sub2_cost_per_unit: float = 57.5,
    ...
    write_lines(
        ...
        [
            ...
            "",
            "[shipping_cold_chain]",
            f"us_fg_sub1_to_sub2_cost_per_unit = {us_fg_sub1_to_sub2_cost_per_unit}",
            f"eu_fg_sub1_to_sub2_cost_per_unit = {eu_fg_sub1_to_sub2_cost_per_unit}",
            f"us_ss_sub1_to_sub2_cost_per_unit = {us_ss_sub1_to_sub2_cost_per_unit}",
            f"eu_ss_sub1_to_sub2_cost_per_unit = {eu_ss_sub1_to_sub2_cost_per_unit}",
            "",
            "[conversion]",
