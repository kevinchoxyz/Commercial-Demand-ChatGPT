...
def write_phase5_scenario(
    ...
    *,
    ...
    ds_shelf_life_months: int = 24,
    dp_shelf_life_months: int = 24,
    fg_shelf_life_months: int = 24,
    ss_shelf_life_months: int = 24,
    excess_inventory_threshold_months_of_cover: float = 6.0,
